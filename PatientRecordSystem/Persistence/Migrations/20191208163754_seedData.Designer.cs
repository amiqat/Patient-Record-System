...
namespace PatientRecordSystem.Persistence.Migrations
{
    ...
    [Migration("20191208163754_seedData")]
            ...
            modelBuilder.Entity("PatientRecordSystem.Domain.Models.Record", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PatientId = 1,
                            TimeOfEntry = new DateTime(2019, 12, 8, 18, 37, 53, 556, DateTimeKind.Local).AddTicks(6867)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            DiseaseName = "ER",
                            PatientId = 1,
                            TimeOfEntry = new DateTime(2019, 12, 8, 18, 37, 53, 560, DateTimeKind.Local).AddTicks(6299)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            DiseaseName = "Eye",
                            PatientId = 1,
                            TimeOfEntry = new DateTime(2019, 12, 8, 18, 37, 53, 560, DateTimeKind.Local).AddTicks(6403)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            DiseaseName = "Surgery",
                            PatientId = 1,
                            TimeOfEntry = new DateTime(2019, 12, 8, 18, 37, 53, 560, DateTimeKind.Local).AddTicks(6412)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            DiseaseName = "Allergies",
                            PatientId = 5,
                            TimeOfEntry = new DateTime(2019, 12, 8, 18, 37, 53, 560, DateTimeKind.Local).AddTicks(6416)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            DiseaseName = "Asthma",
                            PatientId = 1,
                            TimeOfEntry = new DateTime(2019, 12, 8, 18, 37, 53, 560, DateTimeKind.Local).AddTicks(6419)
                        },
                        new
                        {
                            Id = 7,
                            ...
                            DiseaseName = "Asthma",
                            PatientId = 5,
                            TimeOfEntry = new DateTime(2019, 12, 8, 18, 37, 53, 560, DateTimeKind.Local).AddTicks(6423)
                        },
                        new
                        {
                            Id = 8,
                            ...
                            DiseaseName = "Allergies",
                            PatientId = 2,
                            TimeOfEntry = new DateTime(2019, 12, 8, 18, 37, 53, 560, DateTimeKind.Local).AddTicks(6426)
                        });
                });
